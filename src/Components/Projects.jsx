...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="min-h-[200vh] flex flex-col justify-center items-center px-8 pt-6 space-y-6"
    >
      {projects.map((project, index) => (
        <div
          key={index}
          className="relative flex max-w-sm w-full rounded-2xl overflow-hidden border border-gray-600"
        >
          <img
          ...
          <div className="px-6 py-4 w-[150vh] h-[35vh]">
